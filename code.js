...
function create() {
    ...
    player.health = 100;
    player.animations.add('down', ['walk_down_1', 'walk_down_2', 'walk_down_3', 'walk_down_4'], 10, true);
    player.animations.add('right', ['walk_right_1', 'walk_right_2', 'walk_right_3', 'walk_right_4'], 10, true);
    player.animations.add('up', ['walk_up_1', 'walk_up_2', 'walk_up_3', 'walk_up_4'], 10, true);
    player.animations.add('left', ['walk_left_1', 'walk_left_2', 'walk_left_3', 'walk_left_4'], 10, true);
    player.animations.add('sword-down', ['sword_down_1', 'sword_down_2', 'sword_down_3', 'sword_down_4', 'walk_down_1'], 10, false)
    player.animations.add('sword-right', ['sword_right_1', 'sword_right_2', 'sword_right_3', 'sword_right_4'], 10, false)
    player.animations.add('sword-up', ['sword_up_1', 'sword_up_2', 'sword_up_3', 'sword_up_4'], 10, false)
    player.animations.add('sword-left', ['sword_left_1', 'sword_left_2', 'sword_left_3', 'sword_left_4'], 10, false)
